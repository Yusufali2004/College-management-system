...
{
    printf("\n\t\t **** How it Works? ****\n\n");
    printf(" -> You will only able to store the Student's ID, Name, Email, Phone, Number of Subjects.\n");
    printf(" -> A student can have maximum 4 Subjects and minimum 1 Subject.\n");
